...
(function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (typeof this.options.toolbarEx === 'string' || typeof this.options.toolbarEx === 'object') {
            $(sprintf('<div class="bs-bars %s-%s"></div>', bs.pullClass, this.options.toolbarExAlign))
                .appendTo(this.$toolbar)
                .append($(this.options.toolbarEx));
        }
